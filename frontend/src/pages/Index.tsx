...
import { Loader2, MapPin, Star, Clock, Users, Search, TrendingUp, Calendar, Award } from "lucide-react";
    ...
    <main>
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">Book courts in seconds with our streamlined process</p>
          </div>
          <div className="text-center">
            <div className="bg-primary/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <p className="text-muted-foreground">Compare prices and find the best deals in your area</p>
          </div>
          <div className="text-center">
            <div className="bg-primary/10 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <p className="text-muted-foreground">All venues are verified and quality-checked</p>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-12 space-y-6">
        ...
        {venuesLoading ? (
          ...
          <div className="text-center py-8">
            <p className="text-muted-foreground">Unable to load venues at the moment.</p>
            <Button 
              variant="outline" 
      ...
      <section className="container mx-auto px-4 pb-16">
        ...
        {sportsLoading ? (
          ...
          <div className="text-center py-8">
            <p className="text-muted-foreground">Unable to load sports information.</p>
          </div>
        ) : popularSports.length > 0 ? (
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {popularSports.map((sport) => (
              <Card key={sport.id} className="hover:shadow-md transition-shadow cursor-pointer">
                <CardHeader>
      ...
      <section className="bg-muted/50 py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl font-bold text-center mb-8">QuickCourt at a Glance</h2>
      ...
      <section className="container mx-auto px-4 py-16 text-center">
        ...
        <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
          Join thousands of sports enthusiasts who trust QuickCourt for their court bookings. 
